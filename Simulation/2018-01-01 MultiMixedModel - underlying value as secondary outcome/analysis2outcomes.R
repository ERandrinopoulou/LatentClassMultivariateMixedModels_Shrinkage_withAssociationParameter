...
con <- list(program = "JAGS", n.chains = 1, n.iter = 100000,
            n.burnin = 75000, n.thin = 10, n.adapt = 1500, K = 100,
...
parms <- c("betas1","betas2", "tau", "inv.D", "b", "alphas")
#####################



model.fit <- jags.model(file = "multiMixed2outcomes.txt", data = Data, n.chains = con$n.chains, 
