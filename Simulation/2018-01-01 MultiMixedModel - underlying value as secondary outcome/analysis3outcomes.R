...
con <- list(program = "JAGS", n.chains = 1, n.iter = 20000,
            n.burnin = 10000, n.thin = 10, n.adapt = 1500, K = 100,
...
betas3 <- apply(sims.list[[3]][,1:ncX3],2,mean)  # betas3
...
alphas1 <- mean(sims.list[[7]])          # alpha1

alphas2 <- mean(sims.list[[8]])          # alpha1
