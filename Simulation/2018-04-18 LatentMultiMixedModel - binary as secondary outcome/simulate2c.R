...
betaa1 <- c("(Intercept)" = 0.54674145, "Group1" = -1.70988616, "Time1" =  0.02395339)
sigma1.y <- 1.017671  # measurement error standard deviation

# parameters for the linear mixed effects model 
betaa2 <- c("(Intercept)" = -0.96239039, "Group1" = -2.50113490, "Time1" =  0.39765166)

# association parameter
alphaa <- 1.674567#-0.5 # association parameter - value
